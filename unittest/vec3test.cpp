...
BOOST_AUTO_TEST_CASE( multiplyWithScalar )
{
  ...
  double y1 = 3.0;
  double z1 = 4.0;
  Vec3<double> vec(x1,y1,z1);
  Vec3<double> vec2 = vec*4.0;
...
{
  Vec3<double> vec(1.0,2.0,3.0);
  Vec3<double> rhs(-1.0, 3.0,-2.0);
  Vec3<double> result = vec.cross(rhs);
